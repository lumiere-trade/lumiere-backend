...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#2a1f1a] flex flex-col">
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-[#2a1f1a]/80 backdrop-blur-sm">
