...
Usage:
    python -m pourtier.tests.unit.application.test_prepare_deposit_to_escrow
...
class TestPrepareDepositToEscrow(LaborantTest):
    ...
    async def test_prepare_deposit_escrow_not_initialized(self):
        """Test prepare deposit fails if escrow not initialized."""
        self.reporter.info(
    ...
    async def test_prepare_deposit_zero_amount(self):
    ...
    async def test_prepare_deposit_negative_amount(self):
    ...
    async def test_prepare_deposit_bridge_returns_transaction(self):
